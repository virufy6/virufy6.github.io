...
const NavItem: React.FC<{ href: string; text: string; activePath: string }> = ({ href, text, activePath }) => {
  ...
  const mobileStyle = 'w-full py-4 text-center border-gray-500 border-r md:w-auto md:bg-inherit md:text-xl md:border-l-0 md:border-r-0'; // mobile style with vertical borders
