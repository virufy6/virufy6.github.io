                            ...
                            <li className="text-[#393939]">
                                <div>
                                    ...
                                    <div className="hidden peer-hover:flex hover:flex w-[200px] flex-col bg-white drop-shadow-lg fixed">
                                        <Link className="px-5 py-3 hover:bg-gray-200 text-[#393939]" href="/HowItWorks">{ourTechnology?.howItWorks}</Link>
                                        <Link className="px-5 py-3 hover:bg-gray-200 text-[#393939]" href="https://virufy.org/study/welcome">{ourTechnology?.shareYourCough}</Link>
                                        <Link className="px-5 py-3 hover:bg-gray-200 text-[#393939]" href="/Dashboard">{ourTechnology?.OurData}</Link>
                                        <Link className="px-5 py-3 hover:bg-gray-200 text-[#393939]" href="/OurResearch">{ourTechnology?.OurResearch}</Link>
                                    </div>
                                </div>
                            </li>
                            <li className="text-[#393939]">
